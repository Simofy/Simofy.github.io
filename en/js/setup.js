            ...
            if ($('#d_intro_0')[0].getBoundingClientRect().top < $(window).height()
                ...
                for (let el in arr_o_triggers) {
                    if (cwo(arr_o_triggers[el], height_mid, 0.05)) {
                        ...
                        if (el == "wrench") {
                            //special case
                            $('#d_intro_left').html("I put stickers all month.<br> One day I picked flowers.");
                            $('#d_intro_right').html("One day I worked in the recycling field.<br>One month I made sauces.");
                        } else {
                            $('#d_intro_left').html("");
                            $('#d_intro_right').html("");
                        }
